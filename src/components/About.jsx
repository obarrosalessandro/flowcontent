          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-2/5">
              <img 
                ...
                style={{ maxWidth: '1208px', height: 'auto' }}
              />
            </div>
            ...
            <div className="md:w-3/5">
              ...
              <button 
                onClick={scrollToTop}
                className="mt-8 bg-[#2ECC71] hover:bg-[#27AE60] text-white font-bold py-3 px-8 rounded-lg transition duration-300 ease-in-out transform hover:scale-105"
              >
